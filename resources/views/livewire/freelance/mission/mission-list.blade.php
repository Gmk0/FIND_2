<div class="p-6">
    ...
    <div class="container mx-auto">
        ...
        <h2 class="mb-8 text-xl font-semibold tracking-wide text-indigo-600 uppercase">Mission</h2>
        <div class="grid grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-2">
            ...
            <div class="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <p class="mb-2 text-gray-600 dark:text-gray-300">Echance: <span>Du {{$projet->begin_project->format('d
                        F,
                        Y')}} au {{$projet->end_project->format('d F,
                        Y')}}</span></p>
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <x-button href="{{route('freelance.projet.view',[$projet->id])}}" primary flat label="voir" />
