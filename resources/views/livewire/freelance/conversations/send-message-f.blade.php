<div class="flex-none">
    <form wire:submit.prevent='sendMessage' class="flex items-center p-4 bg-gray-100 ">
        <input wire:model.defer="body" type="text" placeholder="Écrire un message"
            class="flex-1 p-2 mr-4 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring focus:border-blue-300">
        <div class="relative">
            <input type="file" class="hidden" id="attachment">
            <button type="button"
                class="flex items-center justify-center p-2 text-white bg-blue-500 rounded-full hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300"
