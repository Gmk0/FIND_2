                ...
                <li>
                    ...
                    <a wire:key='{{$conversation->id}}' href="#" @click="sidebarOpen=!sidebarOpen"
                        ...
                        <img class="object-cover w-10 h-10 rounded-full"
                            src="{{Storage::disk('local')->url('public/profiles-photos/'.$conversation->user->profile_photo_path) }}"
                            alt="">
                        @else
                        <img class="object-cover w-10 h-10 rounded-full"
                        ...
                        <div class="w-full pb-2">
                            <div class="flex justify-between">
                                <span
                                    class="block ml-2 font-semibold text-gray-600 dark:text-gray-200">{{$conversation->user->name}}</span>
        ...
        <div x-bind:class="{'md:block': sidebarOpen, ' hidden md:block ': !sidebarOpen}"
            ...
            <div class="w-full min-h-full ">
                ...
                <div class="flex flex-row items-center justify-between px-3 py-2 bg-grey-lighter">
                    <div class="flex items-center">
                        ...
                        <div @click="isPanelOpen=true" class="flex cursor-pointer ">
                            ...
                            @if (!empty($selectedConversation->user->profile_photo_path))
                            <img class="object-cover w-10 h-10 rounded-full"
                                src="{{Storage::disk('local')->url('public/profiles-photos/'.$selectedConversation->user->profile_photo_path) }}"
                                alt="">
                            @else
                            <img class="object-cover w-10 h-10 rounded-full"
                                src="{{$selectedConversation->user->profile_photo_url }}" alt="">
                            @endif

                        </div>
                        <div class="ml-4">
                            <p class="text-grey-darker dark:text-gray-200 ">
                            ...
                            @else
                            <span
                                class="mt-1 text-sm text-gray-600">{{$selectedConversation->user->last_activity?->DiffForHumans()}}<span>
                                    @endif
                        </div>
                ...
                <div wire:target='chatUserSelected' wire:loading
                    class=" h-[500px] lg:h-[400px] xl:h-[500px] w-full bg-gray-400 animate-pulse">
