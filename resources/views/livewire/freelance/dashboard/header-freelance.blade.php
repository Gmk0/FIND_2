<div>
    <header>
        <nav class="fixed top-0 z-[45] w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                        ...
                        <form action="#" method="GET" class="hidden lg:block lg:pl-3.5">
                            ...
                            <div class="relative mt-1 lg:w-72">
                                ...
                                <button type="button" @click="$dispatch('toggle-spotlight')"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 flex w-full  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400">
                                        <kbd
                                            class="px-2 py-1.5 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">CMD</kbd>
                                        + <kbd
                                            class="px-2 py-1.5 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">K</kbd>

                                    </p>
                                    <p class="text-gray-500 px-2 dark:text-gray-400">
                                        Recherche
                                    </p>
                                </button>
                            </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <!-- Search mobile -->
                        <button id="toggleSidebarMobileSearch" type="button" @click="$dispatch('toggle-spotlight')"
                        ...
                        <!-- Apps -->
                        <button type="button" data-tooltip-target="tooltip-apps" data-dropdown-toggle="apps-dropdown"
                        ...
                        <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <div class="grid grid-cols-3 gap-4 p-4">
                                ...
                                <a href="{{url('/freelance/parametres')}}"
                                    class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <svg class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                ...
                                <a href="{{route('freelance.service.list')}}"
                                    class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <svg class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="text-sm font-medium text-gray-900 dark:text-white">Service</div>
                                </a>
                                <a href="{{route('freelance.commande.list')}}"
                                    class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <svg class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <div class="text-sm font-medium text-gray-900 dark:text-white">Commande</div>
                                </a>
                                <a href="{{route('freelance.transaction.list')}}"
                                    ...
                                    <div class="text-sm font-medium text-gray-900 dark:text-white">Transaction</div>
                                </a>

                            </div>
                        </div>
                        <div id="tooltip-apps" role="tooltip"
