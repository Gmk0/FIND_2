<div x-data="{ isOpen:false,isLoading: true }" x-init="setTimeout(() => { isLoading = false }, 2000) "
    class="min-h-screen">
    <div>
        @include('include.breadcumbUser',['transation'=>'transaction'])
    </div>
            ...
            <div
                ...
                <div class="items-center justify-between lg:flex">
                    <div class="mb-4 lg:mb-0">
                        ...
                        <span class="text-base font-normal text-gray-500 dark:text-gray-400">Liste des dernières
                            transactions</span>
                    </div>
                    <div class="items-center sm:flex">
                            ...
                            <div id="dropdown" class="z-10 hidden w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                                    <li class="flex items-center">
                                        <input id="apple" wire:model.debounce.500ms="pending" type="checkbox"
                                            value="pending"
                                    ...
                                    <li class="flex items-center">
                                        <input id="fitbit" type="checkbox" value="failed"
                                            wire:model.debounce.500ms="failed"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                                    ...
                                    <li class="flex items-center">
                                        <input id="dell" type="checkbox" value="successfull"
                                            wire:model.debounce.500ms="successfull"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                        ...
                        <div wire:ignore date-rangepicker class="flex items-center space-x-4">
                            <div class="relative">
                                ...
                                <input id="start" name="start" type="text" datepicker-format="yyyy/mm/dd"
                            ...
                            <div class="relative">
                                ...
                                <input id="end" name="end" type="text" datepicker-format="yyyy/mm/dd"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="To">
                        ...
                        <div class="mx-2 flex lg:mt-0 mt-2 gap-1">

                            <x-button onclick="Dates()" icon='eye'></x-button>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                    ...
                                    <tbody class="bg-white dark:bg-gray-800">
                                        ...
                                        <tr wire:loading.class='hidden'>
                                            ...
                                            <td
                                                class="p-4 text-sm font-normal text-gray-500 truncate whitespace-nowrap dark:text-gray-400">
                                            ...
                                            <td
                                                ...
                                                @if(isset($transaction->payment_method['brand']) )

                                                @switch($transaction->payment_method['brand'])
                                                @case("visa")
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <label
                                        ...
                                        <input x-model="date" wire:model.deb="Yesterday" type="radio"
                                            class="dark:bg-gray-800" name="dateRange" value="yesterday">
                                        Yesterday
                                    </label>
                                </li>
                                <li>
                                    <label
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                        <input x-model="date" wire:model.debounce.200ms="period" type="radio"
                                            class="dark:bg-gray-800" name="dateRange" value="today">
                                        Ce jour
                                    </label>
                                </li>
                                <li>
                                    <label
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                        <input x-model="date" wire:model.debounce.200ms="period" type="radio"
                                            class="dark:bg-gray-800" name="dateRange" value="last7days">
                                        Derniers 7 jours
                                    </label>
                                </li>
                                <li>
                                    <label
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                        <input x-model="date" wire:model.debounce.200ms="period" type="radio"
                                            class="dark:bg-gray-800" name="dateRange" value="last30days"> Derniers 30
                                        jours
                                    </label>
                                </li>
                                <li>
                                    <label
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                        <input x-model="date" wire:model.debounce.200ms="period" type="radio"
                                            class="dark:bg-gray-800" name="dateRange" value="last90days"> Derniers 9
                                        mois
                                    </label>
                                </li>
                            </ul>
...
Livewire.emit('startDateUpdated', start,end);
