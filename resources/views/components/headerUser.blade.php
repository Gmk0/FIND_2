<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-amber-600 dark:text-amber-300">
        ...
        <h1 :class="isAside ?'hidden':'md:block'" class="ml-3 text-lg font-bold text-gray-800 dark:text-gray-200"
            href="#">
        ...
        <div class="flex justify-center flex-1 lg:mr-32">
            <div class="relative w-full max-w-xl mr-6 focus-within:text-amber-600">
