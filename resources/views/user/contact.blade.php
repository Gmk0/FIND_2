...
<section class="bg-white pt-16 min-h-screen dark:bg-gray-900">
    <div class="container px-6 mt-8  mx-auto">
        <div>


            <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Chat to our friendly team
            </h1>
