...
<body x-data="setup()" x-init="$refs.loading.classList.add('hidden');" @resize.window="watchScreen()" id="body"
        ...
        <nav
            ...
            <div class="flex s-center justify-between mx-auto max-w-screen-2xl">
                ...
                <div class="flex items-center justify-between lg:order-2">
                    ...
                    <!-- Notifications -->
                    <button type="button" @click="isNotificatication=!isNotificatication" class="flex cursor-pointer">
    ...
    <div id="toast-warning"
        class="flex items-center w-full max-w-xs p-4 z-40 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
        role="alert">
        <div
